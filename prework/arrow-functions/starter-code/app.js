...
// arrow function breaks because this cannot be used with arrow function
...
// arrow functions do not work in conjunction with this
...
// It is also undefined in the console.
// 3. Explain why "this" is different when an arrow function is used.
// I'm not quite fully understanding of the isue with this and arrow functions but to quote the ES6 assignment "There are a few caveats with arrow functions, though. Most importantly, the this context is not reset within an arrow function. The value of this is therefore the same as the this of the enclosing scope (the surrounding non-arrow function). If there isn’t a non-arrow function scope surrounding, the this context will be, in the browser, the global window object." I would like to explore this further during class, as I'm still confused by it.
